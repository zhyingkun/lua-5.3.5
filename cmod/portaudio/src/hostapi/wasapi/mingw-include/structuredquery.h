...
typedef /* [v1_enum] */
    enum tagCONDITION_OPERATION { COP_IMPLICIT = 0,
...
typedef /* [v1_enum] */
    enum tagSTRUCTURED_QUERY_SINGLE_OPTION { SQSO_SCHEMA = 0,
...
typedef /* [v1_enum] */
    enum tagSTRUCTURED_QUERY_PARSE_ERROR { SQPE_NONE = 0,
...
/* [v1_enum] */
enum tagSTRUCTURED_QUERY_RESOLVE_OPTION { SQRO_DONT_RESOLVE_DATETIME = 0x1,
...
typedef /* [v1_enum] */
    enum tagQUERY_PARSER_MANAGER_OPTION { QPMO_SCHEMA_BINARY_NAME = 0,
