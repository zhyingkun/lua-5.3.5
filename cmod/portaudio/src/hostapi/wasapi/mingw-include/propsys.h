...
/* [v1_enum] */
enum tagGETPROPERTYSTOREFLAGS { GPS_DEFAULT = 0,
...
/* [v1_enum] */
enum tagPROPENUMTYPE { PET_DISCRETEVALUE = 0,
                       PET_RANGEDVALUE = 1,
                       PET_DEFAULTVALUE = 2,
                       PET_ENDRANGE = 3
};
...
/* [v1_enum] */
enum tagPROPDESC_TYPE_FLAGS { PDTF_DEFAULT = 0,
...
/* [v1_enum] */
enum tagPROPDESC_SORTDESCRIPTION { PDSD_GENERAL = 0,
                                   PDSD_A_Z = 1,
...
/* [v1_enum] */
enum tagPROPDESC_RELATIVEDESCRIPTION_TYPE { PDRDT_GENERAL = 0,
                                            PDRDT_DATE = 1,
                                            PDRDT_SIZE = 2,
                                            PDRDT_COUNT = 3,
                                            PDRDT_REVISION = 4,
...
/* [v1_enum] */
enum tagPROPDESC_AGGREGATION_TYPE { PDAT_DEFAULT = 0,
                                    PDAT_FIRST = 1,
                                    PDAT_SUM = 2,
                                    PDAT_AVERAGE = 3,
                                    PDAT_DATERANGE = 4,
...
/* [v1_enum] */
enum tagPROPDESC_CONDITION_TYPE { PDCOT_NONE = 0,
                                  PDCOT_STRING = 1,
                                  PDCOT_SIZE = 2,
                                  PDCOT_DATETIME = 3,
                                  PDCOT_BOOLEAN = 4,
...
/* [v1_enum] */
enum tagPROPDESC_SEARCHINFO_FLAGS { PDSIF_DEFAULT = 0,
...
typedef /* [v1_enum] */
    enum tagPROPDESC_COLUMNINDEX_TYPE { PDCIT_NONE = 0,
                                        PDCIT_ONDISK = 1,
                                        PDCIT_INMEMORY = 2
...
/* [v1_enum] */
enum tagPROPDESC_ENUMFILTER { PDEF_ALL = 0,
                              PDEF_SYSTEM = 1,
                              PDEF_NONSYSTEM = 2,
                              PDEF_VIEWABLE = 3,
                              PDEF_QUERYABLE = 4,
