...
bcfx.setFrameViewCaptureCallback(function(frameId, viewId, width, height, mb)
	...
	-- bcfx.imageEncodeAsync(mb, width, height, 4, bcfx.image.image_type.PNG, width * 4, function(mb)
	...
	-- 	local mb = bcfx.imageEncodeAsyncWait(mb, width, height, 4, bcfx.image.image_type.PNG, width * 4)
	-- 	local ret = bcfx.writeFileAsyncWait(fileName, mb)
	-- 	print("setFrameViewCaptureCallback Async WriteFile End:", ret)
	-- end)
end)
