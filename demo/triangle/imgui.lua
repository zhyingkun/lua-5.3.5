...
function imgui.setup(mainWin_)
	...
	local mb = bcfx.utils.MakeTextureMemBuffer(image, width, height, 4)
	...
	vertexMemBuffer = bcfx.membuf.CreateMemoryBuffer()
	indexMemBuffer = bcfx.membuf.CreateMemoryBuffer()
